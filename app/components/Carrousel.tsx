  ...
  return (
    <div>
      <div className=" w-4/5 mx-auto">
        ...
        <img src={imgSource? product.imgFront : product.imgBack} width={800} height={800} onClick={()=>setImgSource(prev=>!prev)}/>
        <BiChevronRight
        ...
        {!product.imgBack && <img src={product.imgFront} width={800} height={800} />}

        {!product.imgFront && <img src={product.imgBack} width={800} height={800} />}
      </div>
    </div>
  );
}
