...
function ImageCollage({product}:{product: Product}) {
  ...
  return (
    ...
    <div className="flex">
      <div className="w-1/3">
        <img src={product.imgFront} alt="" onClick={()=>setImgChosen(product.imgFront)} className='cursor-pointer'/>
        <img src={product.imgBack} alt="" onClick={()=>setImgChosen(product.imgBack)} className='cursor-pointer'/>
      </div>
